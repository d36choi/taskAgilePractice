...
describe('RegisterPage.vue', () => {
  ...
  it('should render registration form', () => {
    expect(wrapper.find('.logo').attributes().src)
      .toEqual('front-end/src/assets/logo1.png')
  ...
  //   var username = 'sunny'
  //   var emailAddress = 'sunny@taskagile.com'
  //   var password = 'VueJsRocks!'
  ...
  //   expect(fieldUsername.element.value).toEqual('sunny')
  ...
  it('should fail it is not a new user', async () => {
    ...
    expect(registerSpy).toBeCalled()
    await wrapper.vm.$nextTick()
    expect(fieldUsername.element.value).toEqual('ted')
